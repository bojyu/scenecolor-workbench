  ...
  const results = normalizeCodexOutput({ results: [
    {
      ...
      imageFacingDirection: 'right', angleObservability: 'exact', confidence: 0.93,
      ...
      sameModelConfidence: null, instances: [], multiView: null,
    ...
    },
    {
      ...
      imageFacingDirection: 'right', angleObservability: 'coarse', confidence: 0.95,
    ...
    },
    {
      ...
      imageFacingDirection: 'right', angleObservability: 'exact', confidence: 0.95,
